...
app.controller('friendController', function ($scope) {
    ...
    $scope.list = [
    {value: "name", shown: "Name"}, 
    {value: "friend_count", shown: "Number of Friends"}, 
    {value: "current_location.city", shown: "City"},
    {value: "current_location.state", shown: "State"}, 
    {value: "current_location.country", shown: "Country"}
    ];
